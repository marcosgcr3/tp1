...
public class Messages {
	public static final String SETROLINVALID_COMMAND = "Invalid command parameters";
	public static final String SETROLNOEXISTE_COMMAND = "No existe ese rol";
	public static final String SETROLBAD_COMMAND = "SetRoleCommand error (Incorrect position or no object in that position admits that role)";
	public static final String RESETERROR_COMMAND = "Not valid level number";
	...
	// Save format
	public static final String LEMMING_FORMAT = "%s %s %s %s %s";
	public static final String OBJECT_FORMAT = "%s %s";
...
//Commands
	...
	public static final String OFF_WORLD_SETROLE = "Position %s is off board";
	public static final String SETROLE_ERROR_LEMMING = "No lemming in position %s admits role %s";
	...
	public static final String UNKNOWN_GAME_OBJECT_DIRECTION = "Unknown object direction: \"%s\"";
	/* @formatter:off */
...
//Roles
	...
	//SETROLE
		...
		public static final String WALL_SHORT ="W";
		public static final String METALWALL_NAME = "MetalWall";
		public static final String METALWALL_SHORT = "MW";
		public static final String EXITDOOR_NAME ="ExitDoor";
		public static final String EXITDOOR_SHORT ="ED";
		public static final String LEMMING_NAME ="Lemming";
		public static final String LEMMING_SHORT ="L";
		//Symbols
	...
	public static final String COMMAND_LOAD_INVALID = "Invalid file \"%s\" configuration";
	public static final String COMMAND_LOAD_FILENOTFOUND = "File not found: \"%s\"";
	public static final String COMMAND_LOAD_INVALITGAMESTATUS = "Invalid game status \"%s\"";
	public static final String COMMAND_LOAD_UNKNOWOBJ = "Unknown game object: \"%s\"";
	public static final String COMMAND_LOAD_POSITIONINVALID = "Object position is off board: \"%s\"";
	public static final String COMMAND_LOAD_DIRECTIONUNKNOWN = "Unknown object direction: \"%s\"";
	public static final String COMMAND_LOAD_DIRECTIONINVALID =  "Invalid lemming direction: \"%s\"";
	public static final String COMMAND_LOAD_ROLEINVALID =  "Invalid lemming role: \"%s\"";
	public static final String COMMAND_LOAD_OBJPOSINVALID =  "Invalid object position: \"%s\"";
	...
	public static final String ERROR_ESCRITURA = "\"Ocurrió un error al escribir el archivo: %s ";
	public static final String CORRECTA_ESCRITURA =TAB+"File \"%s\" correctly saved"+LINE_SEPARATOR;
